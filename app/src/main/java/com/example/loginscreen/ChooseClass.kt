...
class ChooseClass : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNext.setOnClickListener {
            ...
            rg1 = findViewById<RadioGroup>(R.id.radioG1)
            rg2 = findViewById<RadioGroup>(R.id.radioG2)
            rg3 = findViewById<RadioGroup>(R.id.radioG3)
            rg4 = findViewById<RadioGroup>(R.id.radioG4)
            ...
            if (radioCheck(selectedTime1, selectedTime2, selectedTime3, selectedTime4)){
                ...
                Toast.makeText(applicationContext, "Time Slot Conflicted", Toast.LENGTH_LONG).show()
            }
    ...
    fun radioCheck(selectedTime1: Int,selectedTime2: Int,selectedTime3: Int
                   ,selectedTime4: Int): Boolean{
